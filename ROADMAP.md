...
**Последнее обновление:** 2026-04-05 — Фаза 6 в процессе (6.1-6.4, 6.11 готовы)  
...
- [ ] **6.9** Взаимодействие скаута: над своим warbase нажать B → экран строительства; над фабрикой → информация `[M]`
